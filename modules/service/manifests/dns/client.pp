...
#   
class service::dns::client ( $nameServer, $domain = $service::dns::client_defaults::domain, $search = $service::dns::client_defaults::search ) inherits service::dns::client_defaults {
    file {
        '/etc/resolv.conf':
